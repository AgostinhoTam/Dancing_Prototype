...
//UW	: UV値横幅
//VH	: UV値高さ
void DrawSprite(int sTex, float X, float Y, float Width, float Height, float U, float V, float UW, float VH)
{
	...
	// テクスチャ設定
	GetDeviceContext()->PSSetShaderResources(0, 1, GetTexture(sTex));
